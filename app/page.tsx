...
export default function Home() {
  return (
    <main
    className='flex min-h-[calc(100vh_-_theme(spacing.40))] w-full items-center justify-center py-8 md:py-0'
  >
    <div className='grid grid-flow-row items-center gap-4 md:grid-flow-col'>
      <div
        className='col-span-1 flex aspect-square items-center justify-center p-8'
      >
        <img
          src='/favicon.png'
          className='size-56'
      ...
      <div className='col-span-1 flex max-w-80 flex-col space-y-2'>
        ...
        <p className='text-lg'>there's also an ethos discussing ego-escalation.</p>
        <br />
